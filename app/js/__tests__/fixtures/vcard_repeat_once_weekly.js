...
const VCalendarSingleWeeklyEvent = [
    'vcalendar',
    [
        ['version', {}, 'text', '2.0'],
    ...
    [
        [
            ...
            [
                ...
                ['dtstart', {'tzid': 'CET'}, 'date-time', '2017-10-01T00:00:00'],
        ...
        [
            ...
            [
                ...
                ['dtstart', {'tzid': 'CET'}, 'date-time', '2017-10-08T00:00:00'],
                ['duration', {}, 'duration', 'P1W']
            ],
            []
        ]
...
export default VCalendarSingleWeeklyEvent;